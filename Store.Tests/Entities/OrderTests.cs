...
namespace Store.Tests.Domain
{
    ...
    public class OrderTests
    {
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_pagamento_do_pedido_seu_status_deve_ser_aguardando()
        {
            var order = new Order(_customer, 0, null);
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_novo_pedodo_valido_seu_total_deve_ser_50()
        {
            var order = new Order(_customer, 0, null);
        ...
        public void Dado_um_desconto_expirado_o_valor_deve_ser_60()
        {
            ...
            var order = new Order(_customer, 0, discountExpired);
